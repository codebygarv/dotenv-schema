...
export type InferType<T extends SchemaOption> = T extends StringSchemaOption
  ? string
  : T extends NumberSchemaOption
  ? number
  : T extends BooleanSchemaOption
  ? boolean
  : T extends UrlSchemaOption
  ? string
  : T extends EmailSchemaOption
  ? string
  : T extends EnumSchemaOption<infer E>
  ? E
  : T extends JsonSchemaOption
  ? any
  : never;
